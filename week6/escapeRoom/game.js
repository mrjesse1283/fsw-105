...
const playerName = readlineSync.question("Thank you for choosing to play with me today, what is your name please? ");

const welcomeMessage = `${playerName}, welcome to the room, choose wisely. `;
